...
public final class IntRangeAffineRangeSum {

    private final int[] dat, lzA, lzB;
    private final int n;
    private final int log;

    public IntRangeAffineRangeSum(int n) {
    ...
    public IntRangeAffineRangeSum(int[] dat) {
        this(dat.length);
        build(dat);
    }
    ...
    public void affine(int l, int r, int a, int b) {
        if (l == r) return;
        l += n; r += n;
        pushTo(l, r);
