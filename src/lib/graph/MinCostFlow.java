...
public class MinCostFlow {
    ...
    private void rangeCheck(int i, @SuppressWarnings("SameParameterValue") int minInlusive, int maxExclusive) {
    ...
    private void nonNegativeCheck(long cap, @SuppressWarnings("SameParameterValue") java.lang.String attribute) {
        if (cap < 0) {
